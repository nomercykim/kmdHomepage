import React, { useEffect, useRef } from 'react'; // React와 관련 훅을 가져옵니다.
...
export default function Home() {
    ...
    const isHomeSectionMainVisible = SectionObserver(sectionMainRef, {
        root: null,
        rootMargin: '0px',
        threshold: 0.1
    });
    ...
    return (
        <div className="h-screen overflow-hidden">
            ...
            <Navbar isHomeSectionMainVisible={isHomeSectionMainVisible} />
