...
export default function HomeSection3({ sectionRef, isScrolled }) {
    return (
        <section ref={sectionRef} className={`opacity-0 transition-opacity duration-1000 ease-in-out whitespace-pre-line bg-gray-300 ${isScrolled ? 'fade-in' : ''} relative z-10 mt-0`}>
        <div className="flex flex-col justify-center h-screen">
            ...
            <div className="pl-144 text-left text-base leading-relaxed">
                {`
                에베소서 5:29-30                
            ...
            <div className="absolute bottom-40 right-40 p-4 text-white text-6xl font-SUITERegular"style={{ lineHeight: '1.4' }}>
                “좋은 자세로 잘 움직이는 것”
            </div>
        </div>
    </section>
