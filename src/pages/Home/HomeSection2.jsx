...
export default function HomeSection2({ sectionRef, isScrolled }) {
    ...
    return (
        <section 
            ...
            whitespace-pre-line mt-10 bg-gray-300 ${isScrolled ? 'fade-in' : ''} relative z-10 mt-0`}
        >
            <div className="flex flex-col items-center justify-center h-screen">
                ...
                <div className="w-2/5 text-left text-base leading-relaxed"style={{ lineHeight: '1.8' }}>
                    {`자세와 움직임이 무너지면,
                    우리 몸이 밸런스를 잡지 못하면
                    4가지 자연스러운 순환이 무너집니다.
                    10가지 생명시스템이 무너집니다.
                ...
                <div className="w-2/5 text-white text-left text-xl font-bold leading-relaxed"style={{ lineHeight: '1.8' }}>
                    {`아주 조금만`}
                </div>
                <div className="w-2/5 text-left text-base leading-relaxed"style={{ lineHeight: '1.8' }}>
                    {`
                ...
                <div className="w-2/5 text-left text-xl leading-relaxed" style={{ lineHeight: '1.8' }}>
                    {`
